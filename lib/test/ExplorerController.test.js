...
describe('Test para ExplorerController', () => {
	...
	test('2.1 Obtener los explorers por names por mission node o java', () => {
		const nameExplorersPorMision = ExplorerController.getExplorersNamesByMission('java');
		expect(nameExplorersPorMision).toStrictEqual(['Woopa6', 'Woopa7', 'Woopa8', 'Woopa9', 'Woopa10']);
	});
});
